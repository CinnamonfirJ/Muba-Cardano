...
const STATUS_TRANSITIONS: Record<string, string[]> = {
  ...
  [ORDER_STATUSES.PAID]: [ORDER_STATUSES.ORDER_CONFIRMED, ORDER_STATUSES.SHIPPED, ORDER_STATUSES.DISPATCHED, ORDER_STATUSES.CANCELLED],
  [ORDER_STATUSES.ORDER_CONFIRMED]: [ORDER_STATUSES.HANDED_TO_POST_OFFICE, ORDER_STATUSES.CANCELLED, ORDER_STATUSES.SHIPPED, ORDER_STATUSES.DISPATCHED],
